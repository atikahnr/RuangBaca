...
class RbfilkomConfig(AppConfig):
    name = 'rbfilkom'
            ...
            for i in obj:
                ...
                if is_denda is None:
                    ...
                    if delta.days >= 1:
                        ...
                        mhs_nimm = TransaksiPeminjaman.objects.values_list("nim", flat=True).get(
                            kode_pinjam=i.kode_pinjam)
                        ...
                        notif = Notifikasi(user=mhs,
                                           ...
                                           kode_pinjam=TransaksiPeminjaman.objects.filter(
                                               kode_pinjam=i.kode_pinjam).last())
                        notif.save()
